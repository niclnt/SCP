...
#define MyAppPublisher "Nicolas"
#define MyAppURL "https://github.com/niclnt/ProyectosSSDL"
#define MyAppExeName "SCP_Launcher.exe"

[Setup]
; Identificador unico (Generalo en Inno Setup -> Tools -> Generate GUID)
...
; Icono del instalador (asegurate de tener scp.ico o borra esta linea)
...
[Files]
; NOTA: Asegurate de que los .exe esten en la carpeta 'dist' antes de compilar esto
...
; Incluimos el LEEME si quieres
; Source: "LEEME.txt"; DestDir: "{app}"; Flags: isreadme

[Icons]
; Crea accesos directos segun lo que se instalo
